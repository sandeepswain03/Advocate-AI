      ...
      <Container>
        <div className="flex flex-col items-center justify-center w-full max-w-3xl mx-auto text-center">
          <h2 className="text-2xl md:text-4xl lg:text-5xl font-heading font-medium !leading-snug mb-6">
            Expand your reach with Advocate AI: Translate content into 60+{" "}
          ...
          <p className="text-sm md:text-lg text-center text-muted-foreground max-w-2xl mx-auto mt-4">
            Break language barriers effortlessly. Advocate AI empowers your
            content to connect with a global audience in just a few clicks.
          </p>
        </div>
      </Container>
